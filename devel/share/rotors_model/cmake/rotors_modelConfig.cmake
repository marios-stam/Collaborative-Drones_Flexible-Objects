...
if("TRUE" STREQUAL "TRUE")
  set(rotors_model_SOURCE_PREFIX /home/marios/catkin_ws/src/rotors_simulator/rotors_model)
  set(rotors_model_DEVEL_PREFIX /home/marios/catkin_ws/devel)
  ...
  set(rotors_model_INSTALL_PREFIX /home/marios/catkin_ws/install)
...
if(NOT "/home/marios/catkin_ws/src/rotors_simulator/rotors_model/include;/usr/include/eigen3 " STREQUAL " ")
  set(rotors_model_INCLUDE_DIRS "")
  set(_include_dirs "/home/marios/catkin_ws/src/rotors_simulator/rotors_model/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rotors_model' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rotors_model' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marios/catkin_ws/src/rotors_simulator/rotors_model/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rotors_model_NUM_DUMMY_TARGETS)
      set(rotors_model_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rotors_model::wrapped-linker-option${rotors_model_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rotors_model_NUM_DUMMY_TARGETS "${rotors_model_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rotors_model::wrapped-linker-option${rotors_model_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rotors_model_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rotors_model_dep}_FOUND)
      find_package(${rotors_model_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rotors_model_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(rotors_model_EXPORTED_TARGETS ${${rotors_model_dep}_EXPORTED_TARGETS})
endforeach()
